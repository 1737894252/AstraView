...
$provider = Join-Path $resolved 'ShellExtension\AstraView.ThumbnailProvider.dll'
...
& (Join-Path $env:WINDIR 'System32\regsvr32.exe') /s $provider
...
Write-Host '安装完成：原生 Explorer 缩略图组件已注册。'
